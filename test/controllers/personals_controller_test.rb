...
class PersonalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create personal" do
    assert_difference('Personal.count') do
      post personals_url, params: { personal: { age: @personal.age, description: @personal.description, sex: @personal.sex } }
    end
  ...
  test "should update personal" do
    patch personal_url(@personal), params: { personal: { age: @personal.age, description: @personal.description, sex: @personal.sex } }
